  ...
  "instructions": [
    {
      ...
      "docs": [
        "Creates a [`CollectionLendingProfile`]."
      ],
      "accounts": [
        {
          "name": "profile",
        ...
        },
        {
          ...
          "isSigner": false,
          "docs": [
            "The mint of the token used by this book to issue loans."
          ]
        },
        {
          "name": "tokenVault",
        ...
        },
        {
          ...
          "isSigner": true,
          "docs": [
            "The authority of the [`CollectionLendingProfile`]"
          ]
        },
        {
          "name": "payer",
    ...
    },
    {
      ...
      "docs": [
        "Closes a [`CollectionLendingProfile`]"
      ],
      "accounts": [
        {
          "name": "profile",
    ...
    },
    {
      ...
      "docs": [
        "Sets the [Status] of a [`CollectionLendingProfile`]"
      ],
      "accounts": [
        {
          "name": "profile",
          ...
          "isSigner": false,
          "docs": [
            "The book of loans for a given collection."
          ]
        },
        {
          "name": "authority",
    ...
    },
    {
      ...
      "accounts": [
        ...
        },
        {
          ...
          "isSigner": false,
          "docs": [
            "The loan offered by the lender."
          ]
        },
        {
          "name": "loanMint",
          ...
          "isSigner": false,
          "docs": [
            "The token mint of the asset being lent."
          ]
        },
        {
          "name": "escrow",
    ...
    },
    {
      ...
      "accounts": [
        ...
        },
        {
          ...
          "isSigner": false,
          "docs": [
            "The escrow's loan token account."
          ]
        },
        {
          ...
          "isSigner": false,
          "docs": [
            "The escrow's collateral account."
          ]
        },
        {
          ...
          "isSigner": false,
          "docs": [
            "The borrower's collateral account."
          ]
        },
        {
          ...
          "isSigner": false,
          "docs": [
            "The token manager's collateral account."
          ]
        },
        {
          "name": "lender",
        ...
        },
        {
          ...
          "isSigner": false,
          "docs": [
            "The Cardinal Token Manager Program."
          ]
        },
        {
    ...
    },
    {
      ...
      "accounts": [
        ...
        },
        {
          ...
          "isSigner": false,
          "docs": [
            "The collateral metadata account."
          ]
        },
        {
          "name": "escrow",
    ...
    },
    {
      "name": "forecloseLoan",
      "docs": [
        "Forecloses a [`Loan`] and claims it's collateral."
      ],
      "accounts": [
        {
          "name": "profile",
        ...
        },
        {
          ...
          "isSigner": false,
          "docs": [
            "The lender's collateral account."
          ]
        },
        {
          "name": "borrowerCollateralAccount",
      ...
      "type": {
        ...
        "fields": [
          ...
          },
          {
            ...
            "docs": [
              "The bump of the vault signer PDA."
            ],
            "type": "u8"
          },
          {
          ...
          },
          {
            "name": "collection",
            "docs": [
              "The Metaplex Collection account."
            ],
            "type": "publicKey"
          },
          {
          ...
          },
          {
            "name": "tokenVault",
            "docs": [
              "The token vault, where fees are sent to."
            ],
            "type": "publicKey"
          },
          {
          ...
          },
          {
            ...
            "docs": [
              "The total loan principal amount originated."
            ],
            "type": "u128"
          },
          {
            ...
            "docs": [
              "The total loan principal amount repaid."
            ],
            "type": "u128"
          },
          {
          ...
          },
          {
            ...
            "docs": [
              "The amount of loans that have been originated."
            ],
            "type": "u64"
          },
          {
            "name": "loansRepaid",
            "docs": [
              "The amount of loans that have been repaid."
            ],
            "type": "u64"
          },
          {
            ...
            "docs": [
              "The amount of loans that have been foreclosed."
            ],
            "type": "u64"
          },
          {
            "name": "loansRescinded",
            "docs": [
              "The amount of loans that have been rescinded."
            ],
            "type": "u64"
          },
          {
            ...
            "docs": [
              "The amount of loans that are currently outstanding."
            ],
            "type": "u64"
          },
          {
            "name": "loansOffered",
            "docs": [
              "The amount of loans that have been offered."
            ],
            "type": "u64"
          },
          {
            ...
            "docs": [
              "The amount of fees accumulated from this book."
            ],
            "type": "u64"
          },
          {
        ...
        "fields": [
          {
            "name": "escrowBumpSeed",
            "docs": [
              "The bump of the escrow account."
            ],
            "type": "u8"
          },
          {
          ...
          },
          {
            "name": "profile",
            "docs": [
              "The [`CollectionLendingProfile`] this loan belongs to."
            ],
            "type": "publicKey"
          },
          {
            "name": "lender",
            "docs": [
              "The lender of this [`CollectionLendingProfile`]."
            ],
            "type": "publicKey"
          },
          {
          ...
          },
          {
            "name": "dueTimestamp",
            "docs": [
              "The timestamp at which the repayment amount is due."
            ],
            "type": "u64"
          },
          {
          ...
          },
          {
            "name": "paidAmount",
            "docs": [
              "The amount of the loan that has been paid."
            ],
            "type": "u64"
          },
          {
